...
class laptop {
   ...
   public function hidupkan_laptop() {
     return "Hidupkan Laptop $this->merk punya $this->pemilik yang warna $this->warna";
   }
  
   public function matikan_laptop() {
     return "Matikan Laptop $this->merk punya $this->pemilik yang warna $this->warna";
   }
